...
<details>
<summary>🔐 Can you decode this? (Click to reveal)</summary>
...
Convert binary to ASCII — it's my name!
</details>
</details>

<details>
<summary>🧩 Decode this Base64</summary>
...
**🛡️ [NetSentry](https://github.com/mohamedsolaiman/netsentry)** — Network Scanner
Multithreaded ARP/TCP/UDP scanner with JSON export

**🔨 [HashForge](https://github.com/mohamedsolaiman/hashforge)** — Hash Cracking Tool
Multi-algorithm hash cracker with benchmark mode

**📋 [LogShield](https://github.com/mohamedsolaiman/logshield)** — Log Analyzer
Security log analyzer with threat detection & alerting

</td>
<td width="50%">

**📝 [NoteForge](https://github.com/mohamedsolaiman/noteforge)** — Flask Web App
Full-stack note-taking app with categories & search

**🔧 [PyToolkit](https://github.com/mohamedsolaiman/pytoolkit)** — CLI Tools
Python beginner CLI projects collection

**⚙️ [AutoPy](https://github.com/mohamedsolaiman/autopy)** — Automation Scripts
30+ Python automation scripts for daily tasks
...
[![Twitter](https://img.shields.io/badge/Twitter-1DA1F2?style=flat-square&logo=twitter&logoColor=white)](https://twitter.com/Mohamed_Sol_)
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=flat-square&logo=vercel&logoColor=white)](https://mohamedsolaiman.vercel.app)
[![Coursera](https://img.shields.io/badge/Coursera-0056D2?style=flat-square&logo=coursera&logoColor=white)](https://www.coursera.org/user/0814a52d75ff35a1304959164ac41ee3)
